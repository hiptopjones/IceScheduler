...
namespace IceScheduler.Formatters
{
    ...
    public class TeamPagesFormatter
    {
        ...
        private static Dictionary<Rink, string> RinkMapping = new Dictionary<Rink, string>() 
        {
            ...
            { Rink.BurnabyLake, "Burnaby Lake Rink" },  
            { Rink.Kensington, "Burnaby Kensington Rink" },  
            { Rink.ChilliwackTwin2, "Chilliwack Twin Rinks - #2" },  
            { Rink.Cloverdale, "Cloverdale Rink" },  
            ...
            { Rink.HarryJerome, "Harry Jerome / Lonsdale Rec Centre" },  
            { Rink.Hillcrest, "Hillcrest Rink / Vancouver Olympic Centre (Riley Park)" },  
            ...
            { Rink.PittMeadowsBlue, "Pitt Meadows Rinks - Volkswagen Blue" }, 
